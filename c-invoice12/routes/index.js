  ...
  getoitfromaccess(obje["ite"], function (oacc) {
    ...
    let docs = {
      ...
      iv: {
        ...
        docdate: obje["div"],
        footer: conf.config.cpayhint
          + "\n" + " ".repeat(6) + conf.config.bank_account_holder
          + ", " + conf.config.bank
          + "\n" + " ".repeat(6) + "IBAN: " + conf.config.iban
          + "\n" + " ".repeat(6) + "Steuernummer: " + conf.config.tax_number
      },
      sr: {
        ...
        footer: conf.config.cpayhint
          + "\n" + " ".repeat(6) + conf.config.bank_account_holder
          + ", " + conf.config.bank
          + "\n" + " ".repeat(6) + conf.config.iban
          + "\n" + " ".repeat(6) + conf.config.tax_number
      },
      de: {
        nme: " ".repeat(iden + 62) + "LIEFERSCHEIN",
        docdate: obje["dde"],
        footer: conf.config.delnote + "\n"
          + "\n..........................................................."
      }
    }
...
rou.get('/wFile.html?', function (req, res) {
  ...
  if (s.r[0].cp > 0) {
    ...
    for (let e of conf.def2[s.r[0].t]) {
